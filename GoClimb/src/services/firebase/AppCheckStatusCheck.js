...
const TAG = 'InitFirebaseAppCheck';

export default function FirebaseAppCheckStatusCheck() {
  ...
  return (
    <View style={{flex: 1, padding: 20}}>
      <Button title="Check Firebase" onPress={handleFirebaseAppCheckInit} />
      ...
      <View
        ...
        {isFirebaseAppCheckInit ? (
          <Text>Firebase AppCheck is initialized ✅</Text>
        ) : (
          <Text>Firebase AppCheck not initialized ❌</Text>
        )}
      </View>
    </View>
  );
