    ...
    <View style={styles.container}>
      <TouchableOpacity
        style={[
          styles.dropdown,
          {
            backgroundColor: hasAvailableModels ? colors.surface : colors.surfaceAlt,
            borderColor: colors.border,
            opacity: hasAvailableModels ? 1 : 0.5,
          },
        ]}
        onPress={() => hasAvailableModels && setModalVisible(true)}
        activeOpacity={0.7}
        ...
        <Ionicons
          name={hasAvailableModels ? 'chevron-down' : 'download-outline'}
          size={20}
